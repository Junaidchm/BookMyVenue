          ...
          {VENUE_CATEGORIES.map((category) => {
            ...
            return (
              <Link
                ...
                className="group flex min-w-35 flex-col items-center gap-3 rounded-2xl border border-border-subtle bg-surface-container-lowest px-6 py-8 transition-all duration-200 hover:-translate-y-0.5 hover:border-primary-container/30 hover:shadow-elevation-card-hover"
              >
